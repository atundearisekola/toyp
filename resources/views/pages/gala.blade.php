      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">GALA NIGHT</h2>
            <h3 class="section-subheading text-muted">And this is how we started.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 ">
            <p>Thank you for your participation in the different stages of the TOYP process so far. It is our pleasure to announce that the Ceremony for the presentation of Awards to the recipients of the JCIN Ten Outstanding Young Persons for 2018 has been scheduled.</p>
            <p>Please be informed that attendance will strictly be by invitation.</p>
            <p>Kindly register and Please note that this registration IS NOT AN AUTOMATIC INVITATION.</p>
          </div>
        </div>
      </div>
    </section>
